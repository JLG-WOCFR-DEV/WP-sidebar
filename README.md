...
- Tableau de bord « Comparatif Pro » résumant les forces et chantiers (UI/UX, accessibilité, fiabilité, visuel) pour aligner l'expérience avec les suites professionnelles haut de gamme.
...
- Nouveaux presets inspirés de Headless UI, Shadcn UI, Bootstrap, Semantic UI, Radix UI et Anime.js pour disposer de palettes et comportements prêts à l’emploi.
...
- Des gestes tactiles optionnels reproduisent l'ouverture par glissement depuis le bord et la fermeture latérale, avec gestion de la zone active et du seuil de déclenchement pour coller aux usages des barres latérales professionnelles.【F:sidebar-jlg/includes/admin-page.php†L404-L459】【F:sidebar-jlg/assets/js/public-script.js†L60-L1269】
- Une option « Mémoire de session » s'appuie sur le stockage local du navigateur pour rouvrir la sidebar comme lors de la dernière visite (sous-menus ouverts, position de scroll, CTA consultés) et peut être activée depuis l'onglet Général.【F:sidebar-jlg/includes/admin-page.php†L404-L410】【F:sidebar-jlg/assets/js/public-script.js†L48-L129】【F:sidebar-jlg/assets/js/public-script.js†L600-L782】
