    ...
    public function enqueueAssets(string $hook): void
    {
        ...
        wp_localize_script('sidebar-jlg-admin-legacy', 'sidebarJLG', [
            ...
            'i18n' => [
                ...
                'widgetsRepeaterMedia' => __('Image (URL)', 'sidebar-jlg'),
                'widgetsRepeaterMediaChoose' => __('Choisir une image', 'sidebar-jlg'),
                'widgetsRepeaterMediaUse' => __('Utiliser cette image', 'sidebar-jlg'),
                'widgetsRepeaterMediaRemove' => __('Retirer l’image', 'sidebar-jlg'),
                'widgetsRepeaterMediaAlt' => __('Texte alternatif', 'sidebar-jlg'),
                'widgetsRepeaterCaption' => __('Légende', 'sidebar-jlg'),
